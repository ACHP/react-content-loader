...
var NativeSvg = /** @class */ (function (_super) {
    ...
    NativeSvg.prototype.render = function () {
        ...
        delete props.speed;
        return (React__default.createElement(Svg, __assign({ viewBox: viewBox, width: width, height: height, preserveAspectRatio: "none", style: composedStyle }, props),
            React__default.createElement(Rect, { x: "0", y: "0", width: parseInt(vbWidth), height: parseInt(vbHeight), fill: "url(#" + this.idClip + ")", clipPath: "url(#" + this.idGradient + ")" }),
